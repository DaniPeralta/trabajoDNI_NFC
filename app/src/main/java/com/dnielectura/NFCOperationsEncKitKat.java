...
public class NFCOperationsEncKitKat extends Activity implements ReaderCallback
{
    ...
    public void HandleError(String strError)
    {
        ...
        Intent myResultIntent = new Intent(NFCOperationsEncKitKat.this, DataErrorActivity.class);
    ...
    public void onCreate(Bundle savedState) {
        ...
        canDnie = ((MyAppDNIELECTURA)getApplicationContext()).getCAN();
    	...
    	btnConfig.setOnClickListener(new OnClickListener() {
    		public void onClick(View v) {
				...
				Intent intent = new Intent(NFCOperationsEncKitKat.this, DataConfiguration.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if ((keyCode == KeyEvent.KEYCODE_BACK)) {
			...
			Intent intent = new Intent(NFCOperationsEncKitKat.this, DNIeLectura.class);
    ...
    void readUserConfiguration()
    {
        ...
        m_readDg1  = sharedPreferences.getBoolean(DNIeLectura.SETTING_READ_DG1, true);
